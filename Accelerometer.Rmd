...
```
The best-performing support vector machine (polynomial) achieved an accuracy of 76.42%. This value is considerably lower than all other models which achieved accuracies above 80%. The best model, a gradient boosted machine, obtained an accuracy of 83.70% with the following parameters: Interaction Depth of 8, 1038 Trees, Shrinkage of 0.01, and 10 Minobsinnode. The confusion matrix for the GBM model can be seen below:
```{r echo=FALSE}
cm_gbm_tst$table
```
